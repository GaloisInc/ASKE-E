...
plainMeasureType :: Qualified MeasureType -> Type
plainMeasureType (Forall _ _ (MeasureType _ _ result)) = result

plainModelType :: ModelType -> Type
plainModelType = id

data MainDecl =
  MainDecl { mainStmts :: [Stmt]
           , mainOutput :: [Expr]
           }
  deriving Show
